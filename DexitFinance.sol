...
abstract contract Ownable is Context {
     ...
     */
    constructor () {
        _owner = 0x80551A4445E44c99c86AcA70F3612097E951e38E;
...
contract DEXIT is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0xbf9CdB79E8990C810BbF758cD514340FC7E4A813;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 4998876543 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "DEXIT";
    string private _symbol = "DXT";
    ...
    uint256 public _maxTxAmount = 9000000 * 10**6;
    uint256 private numTokensSellToAddToLiquidity = 8000000 * 10** 6;
